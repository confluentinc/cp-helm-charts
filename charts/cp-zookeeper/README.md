...
| `resources.limits.cpu` | The upper limit CPU usage for a Zookeeper Pod. | see [values.yaml](values.yaml) for details |
| `resources.limits.memory` | The upper limit memory usage for a Zookeeper Pod. | see [values.yaml](values.yaml) for details |
