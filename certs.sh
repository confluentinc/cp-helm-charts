...
ALT_SERVICE_NAME=$HELM_DEPLOYMENT_NAME-cp-kafka
KEYPASS=test1234
...
DNS.6 = *.$HOSTNAME
DNS.7 = $DNAME
DNS.8 = $ALT_SERVICE_NAME
DNS.9 = $ALT_SERVICE_NAME.$NAMESPACE
DNS.10 = *.$ALT_SERVICE_NAME
DNS.11 = *.$ALT_SERVICE_NAME.$NAMESPACE
EOF
